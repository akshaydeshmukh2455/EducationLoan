...
//
//        Student stu = ss.queryStudentLogin(emailId, password);
//        System.out.println(stu.getEmailId());
//        LoginDto dto = new LoginDto();
//
//        dto.setEmailId(stu.getEmailId());
//        dto.setPassword(stu.getPassword());
//
//        if(dto.validate(emailId, password)) {
...
//    }
	...
	public ResponseEntity<Student> saveStudentData( @RequestBody @Valid Student stu)
	{
